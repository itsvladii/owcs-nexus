<script lang="ts">
    ...
    function handleMouseMove(event: MouseEvent) {
        ...
        hoveredPoint = points.reduce(
            (prev, curr) =>
                Math.abs(curr.x - mouseX) < Math.abs(prev.x - mouseX)
                    ? curr
                    : prev,
            points[0],
        );
                    ...
                    <div>
                        ...
                        <div class="flex gap-4 sm:gap-6 mt-3 font-mono">
                            <div class="flex flex-col">
                                <span
                                    class="text-[8px] text-neutral-500 uppercase"
                                    >Rating</span
                                >
                            ...
                            <div
                                class="flex flex-col border-l border-white/10 pl-4"
                            >
                                <span
                                    class="text-[8px] text-neutral-500 uppercase"
                                    >Peak</span
                ...
                >
                    ...
                    >
                        ...
                        {#each [0, 0.25, 0.5, 0.75, 1] as tick}
                            {@const yPos =
                                padding + (height - padding * 2) * tick}
                            {@const eloVal = Math.round(
                                maxElo - (maxElo - minElo) * tick,
                            )}
                            <line
                                x1={padding}
                                y1={yPos}
                        ...
                        {#if hoveredPoint}
                            ...
                            <g
                                ...
                                width - 150
                                    ? hoveredPoint.x - 130
                                    : hoveredPoint.x + 10}, {hoveredPoint.y -
                                    40})"
                            >
                                <rect
                                    width="120"
                            ...
                            >
                                ...
                                >
                                    <span
                                        ...
                                        ><span
                                            class="text-neutral-600 font-normal italic mr-2"
                                            >VS</span
                                        >
